...
export default function() {
    ...
    return (
      ...
      <div><input placeholder="Nome " id='name' name="name" type="text" {...register("name", {required:true})} /></div>
        ...
        <div><input placeholder="senha" id='password' name="password" type="password" {...register("cpf", {required:true})} /></div>
        {errors.email && <div><h3>Digite Seu CPF</h3></div>}
        
        <div><input id='pwd' name="password confirm" placeholder="confirme sua senha" type="password" {...register("password", { required: true })} /></div>
